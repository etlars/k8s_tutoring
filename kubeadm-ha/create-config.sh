...
export K8SHA_IPLOCAL=10.10.12.11
...
export K8SHA_IPVIRTUAL=10.10.12.16

# master01 ip address
export K8SHA_IP1=10.10.12.11

# master02 ip address
export K8SHA_IP2=10.10.12.12

# master03 ip address
export K8SHA_IP3=10.10.12.13

# master01 hostname
export K8SHA_HOSTNAME1=host01-1.cloud.com

# master02 hostname
export K8SHA_HOSTNAME2=host01-2.cloud.com

# master03 hostname
export K8SHA_HOSTNAME3=host01-3.cloud.com
